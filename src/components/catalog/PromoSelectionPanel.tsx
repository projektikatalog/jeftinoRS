    ...
    <div className="fixed inset-0 z-[100] bg-background flex flex-col">
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="max-w-[150px] truncate">
                          {isCurrent ? `KORAK ${idx + 1}: ${step.title}` : step.title}
                        </span>
                      </button>
                    );
                  })}
      ...
      <main className="flex-1 overflow-hidden flex flex-col md:flex-row container mx-auto">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {promoProducts.length === 0 ? (
            ...
            <motion.div 
              ...
              className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 pb-32"
            >
        ...
        <div className="fixed bottom-0 left-0 right-0 z-[60] md:hidden">
          <div className="bg-card border-t p-4 pb-8 shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
            <div className="container mx-auto">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-lg font-black text-red-600">{activePromotion.ukupna_cena} RSD</p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                {hasSteps ? (
                  ...
                  <Button 
                    onClick={handleNextStep}
                    className="flex-1 h-12 rounded-xl bg-black text-white font-bold"
                  >
                    SLEDEĆI KORAK
                  </Button>
                ) : (
...
function StepProductItem({
  ...
  return (
    <motion.div 
      ...
      layout
      className={`relative group bg-card border-2 rounded-2xl overflow-hidden transition-all duration-300 ${
        isSelected 
    ...
    >
      <div className="aspect-[4/5] relative">
        ...
        />
        {isSelected && (
          <div className="absolute top-2 right-2 bg-emerald-500 text-white w-8 h-8 rounded-full flex items-center justify-center shadow-lg z-10">
            <CheckCircle2 size={20} />
          </div>
        )}
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3">
          <p className="text-white text-xs font-bold truncate">{product.naziv}</p>
        </div>
      </div>
      ...
      <div className="p-3 bg-card">
        {hasSizes && (
          <div className="mb-3 space-y-1.5">
            <p className="text-[10px] uppercase font-bold text-muted-foreground">Veličina:</p>
            <div className="flex flex-wrap gap-1">
              {product.velicine?.map((size) => (
                <button
                  key={size}
                  onClick={() => setSelectedSize(size)}
                  className={`min-w-[32px] h-7 px-2 text-[10px] font-bold rounded border transition-all ${
                    selectedSize === size
        ...
        {hasVariants && (
          <div className="mb-3 space-y-1.5">
            <p className="text-[10px] uppercase font-bold text-muted-foreground">Izaberi varijantu:</p>
            <div className="flex flex-wrap gap-1">
  ...
  return (
    ...
    >
      <div className="aspect-[4/5] relative">
        ...
        />
        {selectedQty > 0 && (
          <div className="absolute top-2 right-2 bg-red-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold shadow-lg z-10">
            {selectedQty}
          </div>
        )}
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3">
      ...
      <div className="p-3 bg-card">
        ...
        <div className="flex items-center justify-between">
          {selectedQty > 0 ? (
            <div className="flex flex-col gap-2 w-full">
              <div className="flex items-center gap-2 bg-muted rounded-xl p-1 w-full">
                <button 
                ...
                <button 
                  ...
                  className="w-8 h-8 flex items-center justify-center hover:bg-background rounded-lg transition-colors disabled:opacity-30"
                >
                  <Plus size={14} />
                </button>
              </div>
              {hasSizes && !selectedSize && selectedQty > 0 && (
                <p className="text-[9px] text-center text-red-500 font-bold">Izaberi veličinu za +/-</p>
              )}
            </div>
          ) : (
            <Button 
